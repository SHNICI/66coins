...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
	// Convert 66:// to 66:
	//
	//    Cannot handle this later, because 66:// will cause Qt to see the part after // as host,
	//    which will lowercase it (and thus invalidate the address).
	if (uri.startsWith("66://")) {
		uri.replace(0, 11, "66:");
	}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
	if (!fAutoStart)
		...
		if (!optionFile.good())
			return false;
		// Write a 66.desktop file to the autostart directory:
...
HelpMessageBox::HelpMessageBox(QWidget *parent)
        : QMessageBox(parent)
{
	header = tr("66-Qt") + " " + tr("version") + " " +
	         QString::fromStdString(FormatFullVersion()) + "\n\n" +
	         tr("Usage:") + "\n" +
	         "  66-qt [" + tr("command-line options") + "]                     " + "\n";
